...
public class Runner {
    public static void main(String[] args) {
        ...
        CarProcessor proc2 = new CarProcessor(cars);
        proc2.printCarsMark("Nissan");
        proc2.printCarsByModelWhichMoreThanYears("Rio", 3);
        proc2.printCarsByModelWhichMoreThanYears("Camry", 3);
        proc2.printCarsByProductYearWithMorePrise(2011, 5000);
    }
